...
** Data Gathering:** The data has been generated by telemarketing campaign of bank and is then uploaded publically on UCI website for study purpose.
...
** Data-preparation:**
   ...
   - Data Split : The entire dataset is divided into 70:30 split into Training and Validation dataset for model building and optmization. And another unseen set of records will be used for Testing 
